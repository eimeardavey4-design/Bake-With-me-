...
const threads = [
  {
    title: "Why do my cakes sink in the middle?",
    category: "cakes",
    author: "Sarah",
    time: "2 hours ago",
    content: "My vanilla cakes rise nicely, but then sink after I take them out of the oven. What could be causing it?",
    likes: 4
  },
  {
    title: "Best way to keep cookies soft?",
    category: "cookies",
    author: "Emma",
    time: "5 hours ago",
    content: "I baked chocolate chip cookies yesterday and they went hard this morning. Any tips for keeping them soft longer?",
    likes: 7
  },
  {
    title: "First time making bread and it came out dense",
    category: "bread",
    author: "Noah",
    time: "1 day ago",
    content: "I followed the recipe, but my loaf turned out heavy and dense. Did I not knead enough, or was it the proofing?",
    likes: 3
  },
  {
    title: "What baking tools should every beginner have?",
    category: "help",
    author: "Lily",
    time: "1 day ago",
    content: "I’m just starting out and don’t want to buy too much at once. What are the essentials?",
    likes: 9
  }
];
...
function addPost(event) {
  ...
  post.innerHTML = `
    <h3>${title}</h3>
    <p class="post-meta">Posted by ${name}</p>
    <p>${message}</p>
  `;
